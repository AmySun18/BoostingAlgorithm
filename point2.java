...
//get angle between two vectors   new added
static double anglecos(point2 a1, point2 c, point2 b1)
{
	point2 vector1=minus(a1,c);
	point2 vector2=minus(b1,c);
	return dot(vector1, vector2)/(vector1.Length()*vector2.Length());
}
