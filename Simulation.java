...
public class Simulation
{
    ...
    public int simulationIteration = 0;
    ...
    public void simulateOneStep()
    {
        ...
        coverage.boost_iteration_textfield.setText(Double.toString(robotList.get(0).iteration));
...
//             ultraLowDetectionBoost = new Double(coverage.UltraLowDetectionBoostTextfield.getText());
    ...
    synchronized public void reset_robots()
    {
        ...
        {	
    		...
    		robotList.get(i).Node_on = false;
    		// Reset for boosting related
    		robotList.get(i).iteration = 0;
    		robotList.get(i).temperature = robotList.get(i).initial_temperature;
        }
    }
