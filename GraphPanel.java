...
//                }
	...
	public void read_nodes_pos() {
		...
		base.x = zoomIn(coverage.sim.baseRobot.position.x);
		base.y = zoomIn(coverage.sim.baseRobot.position.y);	
		for (int i = 0; i < coverage.density.MaxDataSourceNum; i++)
		{
	 ...
	 protected void paintBase(Graphics g, FontMetrics fm)
	    {
	        ...
	        g.drawString("B", x-fm.stringWidth("B")/2, y+4);
...
//                        if (prob > 0.95)
//                        {
//                            offgraphics.setColor(new Color(1f,1f,prob));
//                        }
                        if (prob > 0.5)
 //                       else if (prob > 0.5)
                        {
                        ...
                        else
                        {
                            ...
                            offgraphics.setColor(new Color(250,0,255));
                        }
