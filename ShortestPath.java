...
public class ShortestPath
{
   ...
   public static final double  Eelec = 1;//nominal should be about 100
    ...
    {
    	openSet.clear();
    	 sim.baseRobot.potential_descendants.clear();
         	 ...
         	 for (int i = 0; i < sim.realTimeRobotNumber; i++)
              {
                  ...
                  sim.robotList.get(i).potential_costToBase = linkCost(sim.robotList.get(i).position, sim.baseRobot.position);
                  if(sim.robotList.get(i).potential_costToBase>=0)
                  {                	
                  	sim.robotList.get(i).potential_predecessor = sim.baseRobot;
                  }
              }
    ...
    {
    	openSet.clear();
        sim.baseRobot.descendants.clear();
        ...
        if(sim.coverage.has_connectivity_constraint)
        {
        	 for (int i = 0; i < sim.realTimeRobotNumber; i++)
             {
                 ...
                 openSet.add(sim.robotList.get(i));
                 sim.robotList.get(i).costToBase = linkCost(sim.robotList.get(i).position, sim.baseRobot.position);
                 if(sim.robotList.get(i).costToBase>=0)
                 {                	
                 	sim.robotList.get(i).predecessor = sim.baseRobot;
                 }
             }
